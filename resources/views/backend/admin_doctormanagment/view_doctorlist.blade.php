           ...
           <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title">
                    ...
                    @elseif($route == "doctormanagement.viewalldoctorlist")
                        ...
                        @foreach ($data as $key => $item)
                          <tr>
                              ...
                              <td style="{{ $item->doctor_service==null?'color:red':'' }}"> {{$item->doctor_service==null?"N/A":$item->doctor_service }} </td>
                               ...
                               <td>
                                <a class="btn btn-info" href=" {{Route('doctormanagement.alllist',$item->id)}}">View All Schedules </a>
                                &nbsp;
                                <a class="btn btn-warning" href=" {{Route('doctormanagement.viewallupcommingdoctors',$item->id)}}">Upcomming Schedules </a>
                                &nbsp;
                                <a class="btn btn-danger" href=" {{Route('doctormanagement.viewallpassdoctors',$item->id)}}">Passed Schedules </a>
                                &nbsp;
