            ...
            <!-- Basic Forms -->
             <div class="box">
               <div class="box-header with-border">
                <a href=" {{ route('disease.view') }} " class="btn btn-rounded btn-success md-5" style="float: right"> View Diseases </a>
                 <h3 class="box-title">Add Diseases</h3>
               ...
               <div class="box-body">
                 <div class="row">
                   <div class="col">
                       <form novalidate method="POST" action="{{Route('disease.store')}}" enctype="multipart/form-data"> 
                        @csrf
                         <div class="row">
                        <div class="col-12">	
                            ...
                            <div class="row">
                                <div class="col-md-12"><!--col-6 stared here-->
                                    <div class="form-group">
                                        <h5>Select Main Disease Catagory<span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <select class="form-control" name="disease_main_catagory">
                                                ...
                                                <option value="{{$item->main_catagory_name}}"> {{$item->main_catagory_name}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                              ...
                              <div class="row">
                                  <div class="col-md-12"><!--col-6 stared here-->
                                      <div class="form-group">
                                          ...
                                          <div class="controls">
                                              <input type="text" name="disease_name" class="form-control"  required="" aria-invalid="false"> </div>
                                      </div>
                                  </div><!--col-6 Ended here-->
                              </div>
                              <!--row Ended here-->
                              ...
                              <div class="row">
                                  <div class="col-md-12"><!--col-6 stared here-->
                                      <div class="form-group">
                                          ...
                                          <div class="controls">
                                            <textarea id="editor1" class="ckeditor" name="disease_description" rows="10" cols="80" placeholder="Disease Description">   </textarea>
                                        </div>
                                  </div><!--col-6 Ended here-->
                                 </div>
                                 <!--row Ended here-->
