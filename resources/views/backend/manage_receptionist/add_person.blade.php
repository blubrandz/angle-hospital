            ...
            <!-- Basic Forms -->
             <div class="box">
               <div class="box-header with-border">
                 <h4 class="box-title">Add Receptionist</h4>
                 <a href=" {{ route('reception.view') }} " class="btn btn-rounded btn-success md-5" style="float: right"> View Receptionist </a>
               ...
               <div class="box-body">
                 <div class="row">
                   <div class="col">
                       <form novalidate method="POST" action="{{Route('reception.store')}}"> 
                        @csrf
                         <div class="row">
                           <div class="col-12">	
                               <!--row Stared here-->
                            <div class="row">
                                <div class="col-md-12"><!--col-6 stared here-->
                                    <div class="form-group">
                                        <div class="controls">
                                            <input type="text" value="reception" name="usertype" class="form-control" hidden required> </div>
                                    </div>
