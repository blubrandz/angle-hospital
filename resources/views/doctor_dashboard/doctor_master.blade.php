...
<html lang="en">
  <head>
    ...
    <title>Angle Hospital - Doctor Dashboard</title>
...
<div class="wrapper">
    ...
    <!--header-->
    @include('doctor_dashboard.body.header')

    <!--side bar -->
    @include('doctor_dashboard.body.sidebar')
  ...
  <!-- /.content-wrapper -->
  @include('doctor_dashboard.body.footer')
