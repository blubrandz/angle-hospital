...
<html lang="en">
  <head>
    ...
    <title>Angle Hospital - Reception Dashboard</title>
...
<div class="wrapper">
    ...
    <!--header-->
    @include('reception_dashboard.body.header')

    <!--side bar -->
    @include('reception_dashboard.body.sidebar')
  ...
  <!-- /.content-wrapper -->
  @include('reception_dashboard.body.footer')
