             ...
             <div class="box">
               <div class="box-header with-border">
                <a href=" {{ route('patientappointment.view') }} " class="btn btn-rounded btn-success md-5" style="float: right"> View Your Appoitment</a>
                 <h3 class="box-title">Reschedule Your Day & Time Schedule</h3>
               ...
               <div class="box-body">
                 <div class="row">
                   <div class="col">
                       <form  method="POST" action="{{Route('patientappointment.update' , $resData->id)}}" enctype="multipart/form-data"> 
                        @csrf
                        ...
                        <div class="col-12">	
                               ...
                               <div class="row">
                                <div class="col-md-12"><!--col-6 stared here-->
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="patientappo_phonenumber" class="form-control"   value=" {{ $resData->patientappo_phonenumber }} " aria-invalid="false"> </div>
                                        </div>
                                    </div>
                                </div><!--col-6 Ended here-->
                              </div>
                              ...
                              <input type="text" name="pateintappo_rescedualed" class="form-control"   value=" {{ $resData->pateintappo_rescedualed+1 }} "  aria-invalid="false" style="display: none"> 
...
<script>
    $(document).ready(function() {
        $("#pateintappointment_doctorname").change(function() {
            ...
            let rescedualdataall = $("#rescedualdataall").text() ;
            jQuery.ajax({
                url: '/updategetpatient_doctordate',
                type: 'post',
                data: 'doctornameid='+doctornameid+'&_token={{ csrf_token() }}'+'&rescedualdataall='+rescedualdataall,
...
<script>
    $(document).ready(function() {
        $("#pateintappointment_doctordate").change(function() {
            ...
            jQuery.ajax({
                url: '/updategetpatient_doctortime',
                type: 'post',
